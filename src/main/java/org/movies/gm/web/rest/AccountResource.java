...
import org.movies.gm.domain.PersistentToken;
import org.movies.gm.domain.User;
import org.movies.gm.repository.PersistentTokenRepository;
...
import org.movies.gm.web.rest.vm.KeyAndPasswordVM;
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
                    userDTO.getLangKey(), userDTO.getAvatarURL());
